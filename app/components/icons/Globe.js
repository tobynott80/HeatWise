// Icons free and open source from https://flowbite.com/icons/


const GlobeIcon = () => (
  <svg className="w-4 h-4 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 21 20">
